...
public class Test {
	...
	public static final int BR_NAJVISEG_TESTA = 15;	
	public static final String prvi_dio = "./lab1_laksa/test"; // ako stavis testove u projekt onda je staza relativna
	public static final String ulazni = "/test.in";  //naziv ulaznog filea, paziti na nastavak
	public static final String njihov_izlaz = "/test.out"; //naziv njihovog rezultata, paziti na ekstenziju
	public static final String moj_izlaz = "/izlaz.b";	//ovo može ostat isto
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 1; i <= BR_NAJVISEG_TESTA; i++){
			...
			argsum[0] = ""+i;
			try{
				LeksickiAnalizator.main(argsum);		//POZIVANJE main PROGRAMA KOJI RADITE
		...
		if(nijeBiloGreske == true){
			System.setOut(original);
			System.out.println("Sve je super, svaki test je prošao test!");
		}
	}
}
