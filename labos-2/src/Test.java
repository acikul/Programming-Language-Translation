...
public class Test {
	...
	public static final int BR_NAJVISEG_TESTA = 30;	
	public static final String prvi_dio = "./testovi1/test"; // ako stavis testove u projekt onda je staza relativna
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 1; i <= BR_NAJVISEG_TESTA; i++){
			...
			argsum[0] = ""+i;
			try{
				SintaksniAnalizator.main(argsum);		//POZIVANJE main PROGRAMA KOJI RADITE
